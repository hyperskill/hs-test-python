...
class WrongAnswerThrownInDynamicInput2(StageTest):
...
class Test(unittest.TestCase):
    def test(self):
        status, feedback = WrongAnswerThrownInDynamicInput2(
            'tests.outcomes.wrong_answer_thrown_in_dynamic_input_2.program'
        ).run_tests()

        self.assertTrue("Wrong answer in test #2\n\n"
                        "Add input test 2" in feedback)
